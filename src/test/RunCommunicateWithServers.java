            ...
            Client client = new Client(InetAddress.getLocalHost(), 5400, new IClientStrategy() {
                ...
                public void clientStrategy(InputStream inFromServer, OutputStream outToServer) {
                    try {
                        ...
                        int[] mazeDimensions = new int[]{50, 50}; // maze size
                        toServer.writeObject(mazeDimensions); // send to server
                        toServer.flush();
                        ...
                        byte[] decompressedMaze = new byte[6 + rows * cols]; // ← FIXED!
            ...
            Client client = new Client(InetAddress.getLocalHost(), 5401, new IClientStrategy() {
                ...
                public void clientStrategy(InputStream inFromServer, OutputStream outToServer) {
                    try {
                        ...
                        Solution mazeSolution = (Solution) fromServer.readObject(); // receive solution from server
