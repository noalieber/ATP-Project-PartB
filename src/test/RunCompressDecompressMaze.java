    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            InputStream in = new MyDecompressorInputStream(
                    new FileInputStream(mazeFileName));
        ...
        System.out.println("Original maze size (bytes): " + maze.toByteArray().length);
        System.out.println("Compressed file size (bytes): " + new File(mazeFileName).length());
    }
}
